  ...
  <div class="content">
    <ae-main>
      <ae-panel class="text-center">
        ...
        <h1><ae-icon fill="primary" face="round" name="info" />Corona Phishing Detection</h1>
        <p>
          This domain is currently on the Corona domain warning list. This means that based on information available to us, Corona believes this domain could currently compromise your security and, as an added safety feature, Corona has restricted access to the site. To override this, please read the rest of this warning for instructions on how to continue at your own risk.
        </p>
        <p>
          There are many reasons sites can appear on our warning list, and our warning list compiles from other widely used industry lists. Such reasons can include known fraud or security risks, such as domains that test positive on the <a>Corona Phishing Detector</a>. Domains on these warning lists may include outright malicious websites and legitimate websites that have been compromised by a malicious actor.
        </p>
        <p>
