...
import type { IAETx } from '@/protocols/aeternity/types';
import {
  AE_CONTRACT_ID,
...
/**
 * Base TX interface.
 * @TODO 1: Leave only properties common to all protocols
 * @TODO 2: Remove `IAETx` used as a default
 * @TODO 3: Consider merging with ITransaction to create one flat interface
 */
export type ITx<T extends Record<string, any> = IAETx> = T & {
  abiVersion?: number;
