...
import { AeSdkWallet, send, spend } from '@aeternity/aepp-sdk';
...
/**
 * Digits input type for Contract methods
 */
...
export interface IToken {
  contractId: Encoded.ContractAddress | string
...
/**
 * Support spend method with custom options
 */
type ISpendOptions = Omit<Parameters<typeof spend>[2], 'onAccount' | 'onNode'>;
interface SuperheroSpendOptions extends ISpendOptions {
  modal?: boolean,
  payload: string,
}
...
type ISpend = (
  ...
  recipientIdOrName: Parameters<typeof spend>[1],
  options: SuperheroSpendOptions
) => ReturnType<typeof send>

export type ISuperHeroAeSdk = Omit<AeSdkWallet, 'spend'> & {
  spend: ISpend
}
