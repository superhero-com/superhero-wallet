            ...
            if(typeof this.data.callType !== "undefined" && this.data.callType == 'static') {
                ...
                this.checkSDKReady = setInterval(async () => {
                    if(this.sdk != null) {
                        ...
                        try {
                            const call = await this.$helpers.contractCall({ instance:this.contractInstance, method:this.data.tx.method, params:[...this.data.tx.params, this.data.tx.options] })
                            this.sending = true
            ...
            if (this.isLedger) {
              this.signSpendTxLedger(amount);
                        ...
                        if(this.data.callType == 'pay') {
                            ...
                            const call = await this.$helpers.contractCall({ instance:this.contractInstance, method:this.data.tx.method, params:[...this.data.tx.params,{ fee:this.convertSelectedFee}] })
              });
              this.setTxInQueue(call.hash);
