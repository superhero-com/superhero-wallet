...
export const popupProps = {
  connectConfirm: {"type":"connectConfirm","action":{"params":{"name":"AEPP","networkId":"ae_uat","version":1},"method":"connection.open"},"url":"http://localhost:5000/aepp/aepp","name":"AEPP","protocol":"http:","host":"localhost"},
  messageSign: {"type":"messageSign","action":{"params":{"message":"test"},"method":"message.sign"},"url":"http://localhost:5000/aepp/aepp","name":"AEPP","protocol":"http:","host":"localhost"},
  sign: {"type":"sign","action":{"params":{"tx":"tx_+FkMAaEB3CgyWh2tdZqs4BJVyb/oKE3hK81oYzteWEKnjfZSZ2ehAaH5Fh3pFTFpn4Qi3igqgWqqC8mMZN/OgZ74yFfWCM/thwONfqTGgACGD0w2IAgAAIG+gKIX7fM=","returnSigned":false},"method":"transaction.sign"},"url":"http://localhost:5000/aepp/aepp","name":"AEPP","protocol":"http:","host":"localhost"},
  base: {"type":"sign","action":{"params":{"returnSigned":false},"method":"transaction.sign"},"url":"http://localhost:5000/aepp/aepp","name":"AEPP","protocol":"http:","host":"localhost"}
}
