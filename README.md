...
**Superhero is a browser extension that allows you to send & receive value to URLs & content providers across the internet.**
...
### Add to a browser via local build or release zip
